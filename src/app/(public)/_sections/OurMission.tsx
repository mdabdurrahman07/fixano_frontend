...
export default function OurMission() {
  return (
    <main className="pt-32 pb-24 overflow-hidden bg-surface text-on-surface font-body selection:bg-primary-fixed selection:text-on-primary-fixed">
      {/* Hero Header */}
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-surface-container-lowest border-outline-variant/30 rounded-2xl shadow-none hover:-translate-y-1 transition-transform duration-300">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-on-surface-variant">
                      Rigorous vetting ensures only the top 5% of pros join our
                      network.
                    </p>
                  </CardContent>
                </Card>
              ...
              <blockquote className="text-lg text-on-surface-variant leading-relaxed italic border-l-4 border-primary pl-6 py-1">
                ...
                digital-first platform where quality meets convenience, ensuring
                peace of mind is just a tap away.&rdquo;
              </blockquote>
            </div>
